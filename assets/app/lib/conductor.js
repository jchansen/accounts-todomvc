(function (root, factory) {
  ...
  var Conductor = (function (global, _, Backbone, Marionette, Q) {
    ...
    var Module = Conductor.Module = function (options) {
      ...
      this._configureWreqr(options || {});
      this.initialize.apply(this, arguments);
    };

    var moduleOptions = ['view', 'submodules', 'data', 'loadingView', 'parentModule'];
    ...
    _.extend(Module.prototype, {
      ...
      _configureWreqr: function(options){
        if(this.parentModule === void 0){
          this.vent = new Backbone.Wreqr.EventAggregator();
          this.commands = new Backbone.Wreqr.Commands();
          this.reqres = new Backbone.Wreqr.RequestResponse();
        }else{
          this.vent = this.parentModule.vent;
          this.commands = this.parentModule.commands;
          this.reqres = this.parentModule.reqres;
        }
      },
      ...
      _renderView: function (region) {
        ...
        for (var key in this.data) {
          promises.push(this.data[key](this.options));
          keys.push(key);
        }
    ...
    Conductor.LayoutModule = Conductor.Module.extend({
      ...
      _renderSubmodules: function (layout, defer) {
        ...
        _.each(this.submodules, function (submodule) {
          var module = new submodule["module"]({parentModule: this});
